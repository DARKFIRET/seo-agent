...
export default function Index() {
  ...
  useSEO({
    title: 'SEO и Яндекс Директ - Цифровой маркетинг | Lumina Agency',
    description: 'Помогаем компаниям привлекать целевой трафик и увеличивать продажи через SEO и Яндекс Директ. 7+ лет опыта. 50+ успешных проектов.',
    keywords: [
      'SEO услуги',
      'SEO продвижение',
      'Яндекс Директ',
    ...
    schema: {
      ...
      description: 'Цифровое агентство. SEO и Яндекс Директ для вашего бизнеса',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-foreground/70 mb-8 leading-relaxed">
                Мы помогаем компаниям привлекать целевой трафик, увеличивать
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-foreground/60 max-w-2xl mx-auto mb-8">
              Реальные результаты, которые мы получили для наших клиентов
            </p>
            <Link
              to="/cases"
